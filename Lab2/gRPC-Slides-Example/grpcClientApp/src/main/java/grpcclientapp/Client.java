...
public class Client {
    ...
    private static String svcIP = "34.175.141.242";
    ...
    static void callFindPrime(){
        for(int i = 0; i < 5; i++){
            int start = i*100 + 1;
            int end = (i+1)*100;

            IntervalNumbers interval = IntervalNumbers.newBuilder()
                    .setStart(start)
                    .setEnd(end)
                    .build();

            int finalI = i;
            noBlockStub.findPrimes(interval, new StreamObserver<IntNumber>() {
                @Override
                public void onNext(IntNumber intNumber) {
                    System.out.println("Interval " + finalI + " -> Prime: " + intNumber.getIntnumber());
                }
                ...
                @Override
                public void onCompleted() {
                    System.out.println("Find primes operation completed successfully for interval: " + finalI);
                }
            });

            System.out.println("Request sent for interval [" + start + "," + end + "]");
        }
    ...
    private static int Menu() {
        ...
        do {
            ...
            System.out.println(" 6 - Case find prime");
